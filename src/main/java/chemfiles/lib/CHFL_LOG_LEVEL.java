...
public interface CHFL_LOG_LEVEL {
    public static int CHFL_LOG_ERROR = 0;
    public static int CHFL_LOG_WARNING = 1;
    public static int CHFL_LOG_INFO = 2;
    public static int CHFL_LOG_DEBUG = 3;
}
