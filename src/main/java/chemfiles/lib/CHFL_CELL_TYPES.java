...
public interface CHFL_CELL_TYPES {
    public static int CHFL_CELL_ORTHORHOMBIC = 0;
    public static int CHFL_CELL_TRICLINIC = 1;
    public static int CHFL_CELL_INFINITE = 2;
}
